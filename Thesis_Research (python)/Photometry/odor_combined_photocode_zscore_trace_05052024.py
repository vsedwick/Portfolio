...
project_home = r"E:\VS-Jade_Mated_odor_photometry\zscore_trace\Mated Females"
...
time_from_start=120; time_from_end=10
...
objects=['qtip', 'stick']
check_in_zone=['Sniff', 'Grooming', 'Digging', 'Rearing', 'qtip']
...
def photo_info(_470, _410, fp_frames, project_id):
    ...
    smooth_trace = (smooth_trace-u)/std
